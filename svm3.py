...
def find_first_anomaly(anomalies, test_data, cell):
    if not anomalies.empty:
        first_anomaly_cycle = anomalies['Cycle'].values[0]
...
for cell in range(1, 7):
    ...
    first_anomaly_cycles[cell] = find_first_anomaly(cell_anomalies, test_data, cell)
...
plt.scatter(anomalies["Cycle"], anomalies["Capacity_Cell1"], color='orange', label='Anomalies', zorder=5)
